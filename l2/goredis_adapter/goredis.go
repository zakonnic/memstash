...
func NewJSONCache[K comparable, V any](client redis.Cmdable, opts ...memstash.Option) (*memstash.Cache[K, V], error) {
...
func NewBytesCache[K comparable](client redis.Cmdable, opts ...memstash.Option) (*memstash.Cache[K, []byte], error) {
...
func NewStringCache[K comparable](client redis.Cmdable, opts ...memstash.Option) (*memstash.Cache[K, string], error) {
