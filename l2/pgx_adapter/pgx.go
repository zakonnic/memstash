...
func NewCacheJSON[K comparable, V any](db DB, table string, opts ...memstash.Option) (*memstash.Cache[K, V], error) {
...
func NewCacheBytes[K comparable](db DB, table string, opts ...memstash.Option) (*memstash.Cache[K, []byte], error) {
